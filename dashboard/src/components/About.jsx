  ...
  return (
    <div>
      ...
      <p className="indent-8 text-justify ml-4 mr-10"> Using the data visualizations created in Tableau, 
        the developers  found out a lot of information about the MSMEs.  It doesn’t mean that if you are 
        single, you are rich blah blah blah.</p>
      ...
      <p className="indent-8 text-justify ml-4 mr-10"><b>Kenzo C. Ragundiaz</b> is the team leader of the 
        ...
        front end (website interface).</p>
        <br></br>

      <p className="indent-8 text-justify ml-4 mr-10"><b>Reigniel Cabela</b> is part of the front end 
        team. He is the one that designed the sidebar and the dashboard of the data visualization 
        page.</p><br></br>

      <p className="indent-8 text-justify ml-4 mr-10"><b>John Carlo Lorieta</b> is also a front end designer, the back end developer and the data scientist in charge of creating the data visualization charts using Tableau.</p><br></br>


      <p className="indent-8 text-justify ml-4 mr-10"><b>Renze Torino</b> is a back end developer ensuring the quality and the efficiency of the back end portion of the website. HE is a data visualization enthusiast which cleans and enhances the data 
      quality for further data visualization production.</p>
